...
(function () {
  ...
  function copiedMessage(email) {
    // Locale-pages builds inject the app's own toast (LANDING_STRINGS.copied),
    // already in the page's language; the en/es echo is the classic-mode fallback.
    var bag = window.LANDING_STRINGS || window.TALLY_STRINGS;   // TALLY_STRINGS: the deployed Tally site's name for it
    var injected = bag && bag.copied;
